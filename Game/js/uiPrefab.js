class uiPrefab {
    ...
    create(scene) {
        ...
        //--TIME
        this.time = mainCharacterPrefs.timer;
        ...
        //--HEARTS
        this.hearts = mainCharacterPrefs.mana;
        ...
        this.SetWeaponImage(mainCharacterPrefs.weapon);
    ...
    //Time
    ReduceTime() {
        mainCharacterPrefs.timer--;
        this.timeUi.setText('TIME  ' + (mainCharacterPrefs.timer));
        if (mainCharacterPrefs.timer <= 0) {
            this.s.player.Reset();
        }
